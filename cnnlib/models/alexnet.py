...
架构:
    Input (3, 224, 224)
      → Conv2d(3→96, 11x11, stride=4, pad=2) + ReLU       → (96, 55, 55)
      → MaxPool2d(3x3, stride=2)                            → (96, 27, 27)
      → Conv2d(96→256, 5x5, pad=2) + ReLU                  → (256, 27, 27)
      → MaxPool2d(3x3, stride=2)                            → (256, 13, 13)
      → Conv2d(256→384, 3x3, pad=1) + ReLU                 → (384, 13, 13)
      → Conv2d(384→384, 3x3, pad=1) + ReLU                 → (384, 13, 13)
      → Conv2d(384→256, 3x3, pad=1) + ReLU                 → (256, 13, 13)
      → MaxPool2d(3x3, stride=2)                            → (256, 6, 6)
      → Flatten                                              → (9216)
